...
export type Client = {
   ...
   *  country: phone rules of the form (validation, placeholder, E.164); US when absent. */
  academy: { name: string; phone: string; address: string; mapsUrl: string; logo?: string; photo?: string; country?: Country }
  /** Multi-unit LPs only: the URL paths of this unit ("/quincy" covers "/quincy/book"); the head picks the unit by them. */
  paths?: string[]
